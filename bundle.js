...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.addIngredient = function (e) {
	        var activeIngredList = this.state.recipes[this.state.recipes.indexOf(this.state.selectedRecipe)].ingredients;
	        for (var i = 0; i < activeIngredList.length; i++)
	    ...
	    App.prototype.render = function () {
	        ...
	        if (this.state.selectedRecipe == null)
	            ...
	            details = (React.createElement(RecipeDetails, {"selected": this.state.selectedRecipe, "changeIngred": function (e, index) { return _this.changeIngred(e, index); }, "changeName": function (e) { return _this.changeName(e); }, "addIngredient": function (e) { return _this.addIngredient(e); }, "removeIngredient": function (e, index) { return _this.removeIngredient(e, index); }, "removeRecipe": function (e, recipe) { return _this.removeRecipe(e, recipe); }}));
	        return (React.createElement("div", null, React.createElement("div", {"id": "page-wrapper"}, React.createElement("div", {"id": "title"}, React.createElement("span", {"id": "title-text"}, "Recipe Box"), React.createElement(Foot, null)), React.createElement("div", {"id": "recipe-box"}, React.createElement(RecipeList, {"recipes": this.state.recipes, "selected": this.state.selectedRecipe, "setSelection": function (selection) { return _this.setSelection(selection); }, "addRecipe": function (e) { return _this.addRecipe(); }}), details))));
	    };
	    return App;
	})(React.Component);
	var RecipeList = (function (_super) {
	    __extends(RecipeList, _super);
	    function RecipeList() {
	        _super.apply(this, arguments);
	        this.refList = [];
	    }
	    RecipeList.prototype.componentWillUpdate = function () {
	    ...
	    RecipeList.prototype.render = function () {
	        ...
	        var recipes = this.props.recipes.map(function (recipe, index) {
	            return React.createElement("div", {"className": (_this.props.selected == recipe) ? 'list-item selected' : 'list-item', "ref": function (ref) { return _this.refList.push(ref); }, "key": index, "onClick": function () { return _this.props.setSelection(recipe); }}, recipe.name);
	        });
	        return (React.createElement("div", {"id": "recipe-list"}, React.createElement("div", {"id": "recipe-title"}, "Recipes"), recipes, React.createElement("span", {"className": 'button', "onClick": function (e) { return _this.props.addRecipe(); }}, "Add Recipe")));
	    };
	    return RecipeList;
	})(React.Component);
	var RecipeDetails = (function (_super) {
	    ...
	    RecipeDetails.prototype.componentWillUpdate = function () {
	        //Clear ref list prior to each render, new ones will be populated on render
	        this.refList = [];
	        this.titleRef = null;
	    };
	    RecipeDetails.prototype.componentDidUpdate = function () {
	        if (this.titleRef.readOnly === false)
	            return; // Don't refocus until we're done editing
	        if (this.checkForNewRecipesAndFocus())
	            return;
	        for (var i = this.refList.length - 1; i >= 0; i--) {
	    ...
	    RecipeDetails.prototype.checkForNewRecipesAndFocus = function () {
	    ...
	    RecipeDetails.prototype.checkEmptyIngredsAndFocus = function () {
	        for (var i = this.refList.length - 1; i >= 0; i--) {
	    ...
	    RecipeDetails.prototype.editIngred = function (e) {
	        e.target.readOnly = false;
	        e.target.className = 'editing';
	        e.target.focus();
	        e.target.select();
	    };
	    RecipeDetails.prototype.doneEditing = function (e) {
	        e.target.readOnly = true;
	        e.target.className = 'read-only';
	        this.checkEmptyIngredsAndFocus();
	    };
	    RecipeDetails.prototype.checkForEnter = function (e) {
	        if (e.keyCode === 13)
	            this.doneEditing(e);
	    };
	    RecipeDetails.prototype.render = function () {
	        var _this = this;
	        var selectedRecipe = this.props.selected;
	        var ingredients = selectedRecipe.ingredients.map(function (ingredient, index) {
	            return (React.createElement("div", {"className": "ingredient", "key": index}, index + 1, ".", React.createElement("input", {"className": 'read-only', "value": ingredient, "readOnly": true, "ref": function (ref) { return _this.refList.push(ref); }, "onChange": function (e) { return _this.props.changeIngred(e, index); }, "onClick": function (e) { return _this.editIngred(e); }, "onBlur": function (e) { return _this.doneEditing(e); }, "onKeyDown": function (e) { return _this.checkForEnter(e); }}), React.createElement("i", {"className": 'fa fa-times', "onClick": function (e) { return _this.props.removeIngredient(e, index); }})));
	        });
	        return (React.createElement("div", {"id": "recipe-details"}, React.createElement("div", {"className": 'recipe-title'}, React.createElement("input", {"id": "ingred-title", "className": 'read-only', "ref": function (ref) { return _this.titleRef = ref; }, "value": this.props.selected.name, "readOnly": true, "onChange": function (e) { return _this.props.changeName(e); }, "onClick": function (e) { return _this.editIngred(e); }, "onBlur": function (e) { return _this.doneEditing(e); }, "onKeyDown": function (e) { return _this.checkForEnter(e); }}), React.createElement("i", {"className": 'fa fa-times delete-recipe', "onClick": function (e) { return _this.props.removeRecipe(e); }})), ingredients, React.createElement("span", {"className": 'button', "id": 'ingred-button', "onClick": function (e) { return _this.props.addIngredient(e); }}, "Add Ingredient")));
	    };
	...
	var Foot = (function (_super) {
	    ...
	    Foot.prototype.render = function () {
	        return (React.createElement("div", {"id": "foot"}, React.createElement("a", {"id": "gh-link", "href": "https://github.com/Daynil/recipe-box"}, React.createElement("i", {"className": "fa fa-github-square fa-lg"})), React.createElement("div", {"id": "foot-text"}, "By ", React.createElement("a", {"href": "https://github.com/Daynil/"}, "Daynil"), " for ", React.createElement("a", {"href": "http://www.freecodecamp.com/"}, "FCC"))));
	    };
	    return Foot;
	})(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#page-wrapper {\n  width: 100%;\n  font-family: 'Open Sans';\n  text-align: center;\n  margin-bottom: -50px; }\n  #page-wrapper #title {\n    text-align: center;\n    color: #403e3b; }\n    #page-wrapper #title #title-text {\n      font: bold 40px 'Open Sans';\n      border-bottom: 5px solid #eb7500; }\n      @media only screen and (min-width: 768px) {\n        #page-wrapper #title #title-text {\n          position: relative;\n          left: 100px; } }\n  #page-wrapper .button {\n    display: block;\n    width: 68%;\n    background-color: #eb7500;\n    color: white;\n    padding: 5px 10px 5px 10px;\n    margin: 0 auto;\n    margin-top: 20px;\n    border-radius: 3px;\n    text-align: center; }\n    #page-wrapper .button:hover {\n      cursor: pointer; }\n  #page-wrapper #recipe-box {\n    border: 1px solid #eb7500;\n    border-radius: 20px;\n    margin: 0 auto;\n    position: relative;\n    top: 40px;\n    display: inline-flex;\n    flex-wrap: wrap;\n    color: #403e3b;\n    font-size: 20px;\n    overflow: hidden;\n    /*** Phones ***/ }\n    @media only screen and (max-width: 767px) {\n      #page-wrapper #recipe-box {\n        max-width: 320px; } }\n    #page-wrapper #recipe-box #recipe-list {\n      min-width: 170px;\n      padding-bottom: 20px;\n      /*** Desktop and Tablet ***/\n      /*** Phones ***/ }\n      #page-wrapper #recipe-box #recipe-list #recipe-title {\n        width: 100%;\n        text-align: center;\n        font-size: 25px;\n        font-weight: bold;\n        padding: 10px 0 10px 0;\n        border-bottom: 1px dashed #eb7500;\n        margin-bottom: 10px; }\n      #page-wrapper #recipe-box #recipe-list .selected {\n        background-color: rgba(235, 117, 0, 0.8);\n        color: white; }\n      @media only screen and (min-width: 768px) {\n        #page-wrapper #recipe-box #recipe-list {\n          flex: 1;\n          border-right: 1px solid #eb7500; } }\n      @media only screen and (max-width: 767px) {\n        #page-wrapper #recipe-box #recipe-list {\n          width: 100%;\n          border-bottom: 1px solid #eb7500; } }\n      #page-wrapper #recipe-box #recipe-list .list-item {\n        text-align: center;\n        width: 100%;\n        height: 30px; }\n        #page-wrapper #recipe-box #recipe-list .list-item:hover {\n          cursor: pointer;\n          background-color: rgba(235, 117, 0, 0.3);\n          color: #403e3b; }\n    #page-wrapper #recipe-box #recipe-details {\n      position: relative;\n      padding-bottom: 45px;\n      /*** Desktop and Tablet ***/\n      /*** Phones ***/ }\n      #page-wrapper #recipe-box #recipe-details .read-only {\n        border: 0px;\n        cursor: pointer; }\n      #page-wrapper #recipe-box #recipe-details .editing {\n        outline: none;\n        background-color: rgba(235, 117, 0, 0.3);\n        border: 0; }\n      #page-wrapper #recipe-box #recipe-details #ingred-title {\n        width: 100%;\n        height: 34px;\n        font-size: 25px;\n        font-weight: bold;\n        text-align: center;\n        padding: 10px 0 10px 0;\n        margin-bottom: 10px;\n        border-bottom: 1px dashed #eb7500; }\n      #page-wrapper #recipe-box #recipe-details .delete-recipe {\n        visibility: hidden;\n        color: #eb7500;\n        cursor: pointer;\n        position: absolute;\n        right: 20px;\n        top: 10px;\n        font-size: 30px; }\n      #page-wrapper #recipe-box #recipe-details .recipe-title:hover i {\n        visibility: visible; }\n      #page-wrapper #recipe-box #recipe-details #ingred-button {\n        position: relative;\n        top: 20px; }\n      #page-wrapper #recipe-box #recipe-details .ingredient {\n        margin-left: 20px; }\n        #page-wrapper #recipe-box #recipe-details .ingredient input {\n          font: normal 20px 'Open Sans';\n          color: #403e3b;\n          margin-left: 10px; }\n        #page-wrapper #recipe-box #recipe-details .ingredient i {\n          visibility: hidden;\n          color: #eb7500; }\n        #page-wrapper #recipe-box #recipe-details .ingredient:hover i {\n          visibility: visible;\n          cursor: pointer; }\n      @media only screen and (min-width: 768px) {\n        #page-wrapper #recipe-box #recipe-details {\n          flex: 2; } }\n      @media only screen and (max-width: 767px) {\n        #page-wrapper #recipe-box #recipe-details {\n          width: 100%; } }\n\n#foot {\n  float: right;\n  font-family: 'Ubuntu';\n  font-size: 20px;\n  font-family: 'Open Sans';\n  color: #403e3b;\n  height: 50px;\n  text-align: center;\n  /*** Desktop and Tablet ***/\n  /*** Phones ***/ }\n  @media only screen and (min-width: 768px) {\n    #foot {\n      margin-right: 10px; } }\n  @media only screen and (max-width: 767px) {\n    #foot {\n      margin-right: 23%; } }\n  #foot #foot-text {\n    display: inline-block;\n    position: relative;\n    top: 10px; }\n\n#gh-link {\n  position: relative;\n  top: 9px;\n  right: 5px; }\n\n#foot i, #foot a {\n  color: #eb7500;\n  transition: 0.3s;\n  text-decoration: none; }\n\n#foot a:hover, #gh-link:hover i {\n  color: #403e3b;\n  text-decoration: none; }\n\n#foot i {\n  padding-left: 2px; }\n", ""]);
